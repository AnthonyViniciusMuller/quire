// Package command declares the shape every use case of the reading slice has.
//
...
// the deadline and the cancellation of a call, and nothing else: no use case in
// this slice writes two rows, so none of them opens a unit of work.
